...
export default function WeekActivity({ goals }: { goals: Goal[] }) {
  ...
  if (dayKeys.length === 0) {
    return (
      <div className="max-w-[480px] mx-auto mt-6 text-zinc-400">
  ...
  return (
    <div className="max-w-[480px] mx-auto mt-6 text-zinc-300">
      {dayKeys.map((day) => (
              ...
              {byDay[day].map((item) => (
                ...
                >
                  <div className="text-sm flex items-center gap-2">
                    ...
                    <p>
                      You completed "{item.goalTitle}" at {formatTime(item.timestamp)}
                    </p>
                  </div>
                  <button
                    onClick={() => {
                      ...
                      addNotification({
                        title: "Goal undone ↩️",
                        message: `You’ve undone the goal "${item.goalTitle}".`,
                        type: "reminder",
                      });
                    }}
